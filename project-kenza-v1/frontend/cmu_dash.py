...
# # Callback to update portfolio display
# @app.callback(
#     Output('portfolio-container', 'children'),
#     [Input('risk-profile-store', 'data')]
# )
# def update_portfolio(profile_data):
    # print("we are in update_portfolio", profile_data)
    # if not profile_data:
    #     return html.Div(className="portfolio-chart")
    ...
    #             }],
    #             'layout': {
    #                 'title': f"Asset Allocation for {data['profile']} Risk Profile",
    #                 'showlegend': True,
    ...
    #         style={'height': '500px'}  # Matching container height
    #     )
