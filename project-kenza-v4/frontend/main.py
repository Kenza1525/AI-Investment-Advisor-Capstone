...
# Simulated database (for testing purposes)
users = {}
...
def auth_process(login_clicks, register_clicks, username, password):
    ...
    if triggered_id == "register-btn":
        ...
        if username in users and check_password_hash(users[username], password):
            ...
            # Include JavaScript to force a refresh
            refresh_script = """
            <script>
            if (window.location.pathname !== '/home') {
                window.location.href = '/home';  // Redirect if not already at /home
            } else {
                window.location.reload(true);  // Force reload if already at /home
            }
            </script>
            """
            return '/home', refresh_script, "", "", json.dumps({"username": username})
        else:
