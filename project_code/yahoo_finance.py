...
# import requests
# def get_market_summary(api_key):
...
# def categorize_market_data(market_data):
#     categorized_data = {
#         "Stocks": [],
#         "Commodities": [],
#         "Bonds": [],
...
# def calculate_average_performance(categorized_data):
#     average_performance = {}
...
# def rank_with_normalization(average_performance):
#     rankings = []
...
#     normalized_prices = normalize_data(price_changes)
#     normalized_percents = normalize_data(percent_changes)
...
# #Example usage
# api_key =  "KYpAilMplU1cVSK0H7N1P5OoR2znLbsIJa9yOER1" # Replace with your actual API key
# market_summary = get_market_summary(api_key=api_key)
# if market_summary:
#     categorized_data=categorize_market_data(market_summary)
#     average_performance = calculate_average_performance(categorized_data)
#     rankings = rank_with_normalization(average_performance)
#     for rank, (category, score) in enumerate(rankings, 1):
#         print(f"Rank {rank}: {category} - Score: {score:.2f}")
import requests
